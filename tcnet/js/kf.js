...
var urlroot = "http://imgcdn.bingdou.net/tcnet/kfimages/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
if(kfguin)
{
  rightDivHtml = '<div id="rightDiv" style="position:absolute; top:160px; right:0px;">';
...
{	
  ...
  temp += '<div ><h2 style="line-height:17px; font-size:14px; color:#FFF; margin:0px; padding:10px 0 13px 8px;">&nbsp;</h2></div>';
...
{
	window.open('http://wpa.qq.com/msgrd?v=3&uin='+kfguin+'&site=qq&menu=no', '_blank', 'height=544, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
...
{ 
	...
	var now = new Date();
    img.src = "http://wpa.qq.com/msgrd?v=3&uin=" + kfguin + "&site=qq&menu=no";
