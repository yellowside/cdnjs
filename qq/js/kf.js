...
var urlroot = "http://imgcdn.bingdou.net/qq/kfimages/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
if(kfguin)
{
  rightDivHtml = '<div id="rightDiv" style="position:absolute; top:160px; right:0px;display:none;">';
  ...
  if(type==1 && kf_getCookie('hasshown')==0)
  {
      ...
      window.setTimeout("kf_sleepShow()",3000);
      //kf_sleepShow();
  }
