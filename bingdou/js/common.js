...
//用户登录状态
url="https://"+host+"/e/member/login/loginjs.php";
...
$(
 function(){
	 if (classid && id){
		 $("#playbox").load("https://"+host+"/e/DownSys/play/?classid="+classid+"&id="+id+"&pathid=0");
	 }
 }
)
}
...
if(isNeeded('.bdsharebuttonbox')){
	window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"24"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='https://cdn.jsdelivr.net/gh/yellowside/baiduShare/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
}
//tongji
var _hmt = _hmt || [];
(function() {
